...
#define  AK_ISP_VP_GET_BLC			_IOR(AKISP_MAGIC,  1, int)    /*背光补偿*/
#define  AK_ISP_VP_SET_BLC			_IOW(AKISP_MAGIC,  2, int)	
#define  AK_ISP_VP_GET_LSC      	_IOR(AKISP_MAGIC,  3, int)	  /*暗角补偿*/
...
#define  AK_ISP_VP_GET_RAW_LUT		_IOR(AKISP_MAGIC,  9, int)  /*和调色有关*/
